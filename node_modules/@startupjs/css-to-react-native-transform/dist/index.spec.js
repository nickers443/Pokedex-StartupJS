...
describe("border", function () {
  ...
  describe("shorthand border properties related to Image elements", function () {
    ...
    it("transforms border-color with hex color", function () {
      expect((0, _index["default"])("\n        .test {\n          border-color: #f00;\n        }\n      ")).toEqual({
        test: {
          borderColor: "#f00"
        }
    ...
    it("transforms border-color with rgb color", function () {
    ...
    it("transforms border-color with rgba color", function () {
...
describe("::part() selectors", function () {
  it("transforms ::part() selectors", function () {
  ...
  it("does not transform ::part() selectors without option enabled", function () {
    expect((0, _index["default"])("\n        .container {\n          background-color: #f00;\n        }\n\n        .container::part(input) {\n          background-color: #00f;\n        }\n        ", {})).toEqual({
      container: {
        backgroundColor: "#f00"
      }
